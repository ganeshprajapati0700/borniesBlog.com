...
@section('content')
    ...
    <x-page-header title="Create New User" subtitle="Add a new user to organize your posts" buttonLabel="Back to Users"
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form action="{{ route('users.store') }}" method="post" class="space-y-6">
            @csrf
            <x-input-field label="User Name" type="text" name="name" placeholder="Admin" value="{{ old('name') }}"
                required />
